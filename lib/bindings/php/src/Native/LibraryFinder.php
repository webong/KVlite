...
{
    public static function find(?string $requestedPath = null): string
    {
        $candidates = [];
        ...
        if (is_string($home) && $home !== '') {
            $candidates[] = rtrim($home, DIRECTORY_SEPARATOR).DIRECTORY_SEPARATOR.'lib'.DIRECTORY_SEPARATOR.$libraryName;
        }
